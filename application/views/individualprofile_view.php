...
<head>
    ...
    <title><?php echo lang('individual');?></title> <!-- Edit title -->
</head>
<body>
    ...
    <div id="container">
        ...
        <center>
            <div class="row">
                ...
                <div class="col-md-4">
                    <img src="<?php echo base_url().'application/assets/images/user.png' ?>" alt="" width="150px" height="150px">
                </div>
            </div>
        </center>
        <center>
            <?php 
                ...
                $users = $this->IndividualProfileModel->get_details();
                $user = $users[0];
            ?>
            <?php echo form_open_multipart('index.php/individualprofile/update')?>
                <div class="card w-75">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <img src="<?php if($user->image == NULL) echo base_url().'application/assets/images/user.png'; else echo base_url().'application/assets/images/users/'.$user->image;?>" alt="" width="150px" height="150px">
                                <div class="enviar">
