    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link <?php if($this->session->userdata('active') == 'home') echo 'nav-active'; ?>" href="<?php echo base_url().'index.php/individualhome' ?>"><?php echo lang('home');?>
              <span class="sr-only">(current)</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link <?php if($this->session->userdata('active') == 'individualprofile') echo 'nav-active'; ?>" href="<?php echo base_url().'index.php/individualprofile' ?>">Individual</a>
          </li>
        </ul>
      </div>
    </div>
