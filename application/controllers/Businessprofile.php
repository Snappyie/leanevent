...
class BusinessProfile extends CI_Controller {
    function index(){
        ...
        $this->BusinessProfileModel->get_details();
		$this->BusinessProfileModel->load_view();
    }
    function update(){
        ...
        if($this->form_validation->run() == FALSE) {
            ...
            $this->load->model('BusinessProfileModel');
            $file_path = "";
            if($this->BusinessProfileModel->get_details()[0]->image == NULL){
                ...
                $file_path = $this->BusinessProfileModel->get_details()[0]->image;
            $this->BusinessProfileModel->update_details($file_path);
        }
    }
